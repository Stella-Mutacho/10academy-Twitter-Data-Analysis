...
class Clean_Tweets:
    ...
    def drop_duplicate(self, df:pd.DataFrame)->pd.DataFrame:
        ...
        df.drop_duplicates(subset= ['created_at', 'source', 'original_text', 'polarity', 'subjectivity', 'lang', 'favorite_count',
    ...
    def convert_to_datetime(self, df:pd.DataFrame)->pd.DataFrame:
        ...
        """
        df['created_at'] = df['created_at'].astype('datetime 64[ns]')
        df['created_at'] = df.created_at.dt.to_pydatetime()
        
        df['created_at'] = ['2020-12-31' ]
    ...
    def remove_non_english_tweets(self)->pd.DataFrame:
        ...
        tweet_df = pd.read_csv("../data/Economic_Twitter_Data.csv")
